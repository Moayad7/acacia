...
const productsTitle = () => {
    if (language === "en") {
      document.getElementById("products-item-title").innerHTML = products[productsID].title;
      document.getElementById("products-item-description").innerHTML = products[productsID].description;
      document.getElementById("products-item-photo").classList.add(`bg-[url('http://dash.sa-acacia.com/serImage/${products[productsID].icons}')]`);
    } else {
      console.log(productsID)
      document.getElementById("products-item-title").innerHTML = products[(products.length-1) - productsID].title;
      document.getElementById("products-item-description").innerHTML = products[(products.length-1) - productsID].description;
      document.getElementById("products-item-photo").classList.add(`bg-[url('http://dash.sa-acacia.com/serImage/${products[(products.length-1) - productsID].icons}')]`);
    }
  };

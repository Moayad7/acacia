...
const workshopTitle = () => {
    if (language === "en") {
      document.getElementById("workshop-item-title").innerHTML = workshop[workshopID].title;
      document.getElementById("workshop-item-description").innerHTML = workshop[workshopID].description;
      document.getElementById("workshop-item-photo").classList.add(`bg-[url('http://dash.sa-acacia.com/serImage/${workshop[workshopID].icons}')]`);
    } else {
      console.log(workshopID)
      document.getElementById("workshop-item-title").innerHTML = workshop[(workshop.length-1) - workshopID].title;
      document.getElementById("workshop-item-description").innerHTML = workshop[(workshop.length-1) - workshopID].description;
      document.getElementById("workshop-item-photo").classList.add(`bg-[url('http://dash.sa-acacia.com/serImage/${workshop[(workshop.length-1) - workshopID].icons}')]`);
    }
  };
